...
class Convert():
    ...
    def Set_Document( self, cmodel, n_cd, n_cp ):
        self.cmodel = cmodel
        self.n_cd = n_cd
        self.n_cp = n_cp
    ...
    def Set_Matrix( self, matrix ):
        ...
        # Colormatch RGB
        elif matrix == "ColorMatch RGB (D50)":
        ...
        # Ekta Space PS5
        elif matrix == "Ekta Space PS5 (D50)":
        ...
        # Wide Gamut
        elif matrix == "Wide Gamut RGB (D50)":
    ...
    def Ask_Document( self ):
        return self.cmodel, self.n_cd, self.n_cp
    def Ask_Hue( self ):
        return self.hue
...
class Analyse():
    ...
    # Bytes
    def Bytes_to_Integer( self, byte_array, n_cd ):
        ...
        # Return
        return num_array
    def Integer_to_Bytes( self, num_array, n_cd ):
